        ...
        <div class="container-fluid center-align sign">
            <div class="container">
                ...
                <div class="row">
                    <div class="col s12">
                        <ul class="tabs">
                            <li class="tab col s3"><a href="#test2">Edit Trainer</a></li>
                        </ul>
                    </div>
                                        ...
                                        <form class="col s12" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="center-align">
                                                    <button type="submit" id="confirmed" name="edittrainer" class="btn meh button-rounded waves-effect waves-light ">Update</button>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="center-align">
                                            <a href="alltrainer.php"><button class="btn meh button-rounded waves-effect waves-light red">Back</button></a>
                                        </div>
